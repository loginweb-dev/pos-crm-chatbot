    ...
    @else
        <div class="col-sm-6 col-md-6 col-lg-6" id="mitop">
            <div class="btn-group" role="group" aria-label="Basic example">
                ...
                <button type="button" class="btn btn-default" data-toggle="modal" data-target="#venta_caja" onclick="venta_caja()">Mis Ventas</button>
                <button onclick="micliente()" type="button" class="btn btn-default" data-toggle="modal" data-target="#modal_cliente">Clientes</button>
...
@section('content')
                        ...
                        <div class="panel-body">
                            ...
                            @if ($edit)
                                @php
                                    ...
                                    $opciones = App\Option::where('view', 'backend')->orderBy('created_at', 'desc')->get();
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-12">
                                        <div class="form-group">
                                            <label for="">Editor {{ $venta->register_id }}</label>
                                            <input class="form-control" type="text" name="register_id" id="register_id" value="{{ $venta->register_id }}" readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-12">
                                        <div class="form-group">
    ...
    <div id="chat-circle" class="btn btn-raised">
        <div id="chat-overlay"></div><i class="voyager-helm"></i>
    </div>
    <div class="chat-box">
        <div class="chat-box-header">
            CHATBOT v1.0
            <span class="chat-box-toggle"><i class="voyager-x"></i></span>
        </div>
        ...
        <div class="chat-input">
            <form>
                ...
                <button type="submit" class="chat-submit" id="chat-submit"><i class="voyager-paper-plane"></i></button>
            </form>
        </div>
    </div>
    {{-- </div> --}}
...
<!-- <script src="https://socket.loginweb.dev/socket.io/socket.io.js"></script> -->
    <script>
        ...
        if (localStorage.getItem('micaja')) {
            ...
            $("#info_caja").html("<h4>"+micaja.title+" - "+micaja.sucursal+" - "+micaja.importe+" Bs. - <a href='#' onclick='reset()'>Reset</a> <span class='badge badge-dark'> FATCOM v3.0.2 </span></h4>");
        }else{
            $("#micaja").modal();
        }
